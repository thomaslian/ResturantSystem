...
/**
 * Created by Thoma on 17-Jan-18.
 */

public class ViewOrderAdapter extends ArrayAdapter<Order> {
     ...
     */
    public ViewOrderAdapter(Activity context, ArrayList<Order> arrayList) {
